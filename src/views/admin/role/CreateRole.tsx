...
const formValidations: FormRoleValidations = {
  ...
  description: [(value: string) => value.length >= 1, 'Debe ingresar una descripcion'],
...
export const CreateRole = (props: createProps) => {
  ...
  const {
    ...
    nameValid, descriptionValid, permissionIdsValid } = useForm(item ?? formFields, formValidations);
